    ...
    "translations": {
      "en": {
        "consentModal": {
          ...
          "description": "New Era Tours uses cookies to enhance your experience, analyze site usage, and assist in our marketing efforts. You can manage your preferences anytime.",
    ...
    contactForm.addEventListener('submit', async function(e) {
        ...
        try {
            ...
            const response = await fetch('https://api.zappy5.com/api/email/contact-form', {
                ...
                body: JSON.stringify({
                    websiteId: '82445600-5405-4927-9a14-a9ae5abe2b5d',
                    name: data.name || '',
                    email: data.email || '',
